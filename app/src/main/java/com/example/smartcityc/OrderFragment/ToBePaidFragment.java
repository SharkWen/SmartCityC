...
public class ToBePaidFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_to_be_paid, container, false);
        context = getContext();
        bindView();
        initData();
        return view;
    ...
    private void initData() {
        Tool.getTokenData("/prod-api/api/takeout/order/list?status=待支付&pageNum=1&pageSize=8", Tool.sp(context, "token"), new Callback() {
            @Override
