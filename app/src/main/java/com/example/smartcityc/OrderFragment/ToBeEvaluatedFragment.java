...
public class ToBeEvaluatedFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Inflate the layout for this fragment
        view = inflater.inflate(R.layout.fragment_to_be_evaluated, container, false);
        context = getContext();
        bindView();
        initData();
        return view;
    ...
    private void initData() {
        Tool.getTokenData("/prod-api/api/takeout/order/list?status=待评价&pageNum=1&pageSize=8", Tool.sp(context, "token"), new Callback() {
            @Override
